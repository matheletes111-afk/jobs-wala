  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center gap-10 linear-card px-4 relative overflow-hidden rounded-[3rem] shadow-xl my-12 mx-4 md:mx-8">
      ...
      <div className="relative group">
        ...
        {/* Core Loader Node */}
        <div className="relative flex h-24 w-24 items-center justify-center rounded-3xl bg-white border border-slate-200 shadow-md transition-transform group-hover:scale-110 duration-500">
      ...
      <div className="text-center relative z-10">
        <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-full bg-slate-100 border border-slate-200">
          <ShieldCheck className="w-3 h-3 text-emerald-500" />
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500">Access Verified</span>
        </div>
        <h2 className="text-2xl font-black text-foreground tracking-tighter mb-2 uppercase italic">Loading Your Dashboard</h2>
        <p className="text-primary/80 text-[10px] font-bold uppercase tracking-widest animate-pulse italic">Synchronizing your professional profile...</p>
      </div>
