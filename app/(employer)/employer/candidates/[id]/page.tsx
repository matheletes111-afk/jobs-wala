            ...
            <div className="shrink-0">
              <Link href="/employer/search">
                <Button
                  variant="ghost"
                  size="sm"
                  className="gap-3 h-10 px-5 rounded-xl bg-slate-100 border border-slate-200 text-[10px] font-black uppercase tracking-widest text-slate-700 hover:bg-slate-200 transition-all active:scale-95 group"
                >
